...
[ -z "$url" ] && url="https://fastly.jsdelivr.net/gh/smxs666/v2b-linux@master"
...
echo -----------------------------------------------
$echo "\033[33m注意：安装此客户端至少需要预留约1MB的磁盘空间\033[0m"
if [ -n "$systype" ];then
...
setversion(){
	echo -----------------------------------------------
	$echo "\033[33m环境准备完毕，请问是否继续安装：\033[0m"	
	$echo " 1 \033[32m继续\033[0m"
	$echo " 0 \033[31m退出\033[0m"
	echo -----------------------------------------------
	read -p "请输入相应数字 > " num
	case "$num" in
	0)
